...
const Page = () => {
  return (
    <main className="mx-9 mb-10 flex flex-col items-center">
      <h4 className="text-4xl font-bold">Datenschutzerklärung</h4>
      <div className="flex max-w-[1000px] flex-col gap-10">
        <p className="my-5 text-xl">
          Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
          Datenschutz hat einen besonders hohen Stellenwert für die
          Geschäftsleitung der Arbeiterunion. Eine Nutzung der Internetseiten
          der Arbeiterunion ist grundsätzlich ohne jede Angabe personenbezogener
        ...
        <p className="my-5 text-xl">
          ...
          und in Übereinstimmung mit den für die Arbeiterunion geltenden
        ...
        <p className="my-5 text-xl">
          Die Arbeiterunion hat als für die Verarbeitung Verantwortlicher
        ...
        <h4 className="text-4xl font-bold">1. Begriffsbestimmungen</h4>
        <p className="my-5 text-xl">
          Die Datenschutzerklärung der Arbeiterunion beruht auf den
        ...
        <ul>
          <li>
            <h4 className="text-2xl font-bold">a) personenbezogene Daten</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">b) betroffene Person</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">c) Verarbeitung</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">e) Profiling</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">f)  Pseudonymisierung</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">h) Auftragsverarbeiter</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">i)   Empfänger</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">j)   Dritter</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">k) Einwilligung</h4>
            <p className="my-5 text-xl">
        ...
        <p className="my-5 text-xl">Arbeiterunion</p>
        <p className="my-5 text-xl">8400 Winterthur</p>
        <p className="my-5 text-xl">Schweiz</p>
        <p className="my-5 text-xl">Website: https://www.1mai-winterthur.ch/</p>

        <h4 className="text-4xl font-bold">3. Cookies</h4>
        <p className="my-5 text-xl">
          Die Internetseiten der Arbeiterunion verwenden Cookies. Cookies sind
        ...
        <p className="my-5 text-xl">
          Durch den Einsatz von Cookies kann die Arbeiterunion den Nutzern
        ...
        <p className="my-5 text-xl">
          Die Internetseite der Arbeiterunion erfasst mit jedem Aufruf der
        ...
        <p className="my-5 text-xl">
          ...
          Arbeiterunion keine Rückschlüsse auf die betroffene Person. Diese
          ...
          Arbeiterunion daher einerseits statistisch und ferner mit dem Ziel
        ...
        <h4 className="text-4xl font-bold">6. Rechte der betroffenen Person</h4>
        <ul>
          <li>
            <h4 className="text-2xl font-bold">a) Recht auf Bestätigung</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">b) Recht auf Auskunft</h4>
            <p className="my-5 text-xl">
          ...
          <li>
            <h4 className="text-2xl font-bold">c) Recht auf Berichtigung</h4>
            <p className="my-5 text-xl">
              Jede von der Verarbeitung personenbezogener Daten betroffene
              Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
          ...
          <li>
            ...
            <p className="my-5 text-xl">
              ...
              bei der Arbeiterunion gespeichert sind, veranlassen möchte, kann
              sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
              Arbeiterunion wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>

            <p className="my-5 text-xl">
              Wurden die personenbezogenen Daten von der Arbeiterunion
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft die Arbeiterunion unter
              ...
              der Arbeiterunion wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            <h4 className="text-2xl font-bold">
            ...
            <p className="my-5 text-xl">
              ...
              Daten, die bei der Arbeiterunion gespeichert sind, verlangen
              ...
              Arbeiterunion wird die Einschränkung der Verarbeitung veranlassen.
            </p>
          </li>
          <li>
            <h4 className="text-2xl font-bold">
            ...
            <p className="my-5 text-xl">
              ...
              Arbeiterunion wenden.
            </p>
          </li>
          <li>
            <h4 className="text-2xl font-bold">g) Recht auf Widerspruch</h4>
            <p className="my-5 text-xl">
              Jede von der Verarbeitung personenbezogener Daten betroffene
              Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
            ...
            <p className="my-5 text-xl">
              Die Arbeiterunion verarbeitet die personenbezogenen Daten im Falle
            ...
            <p className="my-5 text-xl">
              Verarbeitet die Arbeiterunion personenbezogene Daten, um
              ...
              Person gegenüber der Arbeiterunion der Verarbeitung für Zwecke der
              Direktwerbung, so wird die Arbeiterunion die personenbezogenen
            ...
            <p className="my-5 text-xl">
              ...
              Verarbeitung personenbezogener Daten, die bei der Arbeiterunion zu
            ...
            <p className="my-5 text-xl">
              ...
              Person direkt an jeden Mitarbeiter der Arbeiterunion oder einen
          ...
          <li>
            ...
            <p className="my-5 text-xl">
              ...
              Arbeiterunion angemessene Maßnahmen, um die Rechte und Freiheiten
